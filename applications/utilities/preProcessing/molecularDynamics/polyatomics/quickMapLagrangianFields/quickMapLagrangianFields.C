...
Description
    ...
    The mesh of the new case is changed. (e.g. run blockMesh)

    The utlity then checks that the molecule-to-cell addressing is correct.

    IMP: Not parallelised. Doesn't necessarily need to be, since it is not 
...
#   include "createRandom.H"
    ...
    polyMoleculeCloud molecules(runTime, mesh, pot, redUnits, rndGen, "quickMapping", false);

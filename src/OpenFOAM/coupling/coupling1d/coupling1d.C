...
Foam::coupling1d::coupling1d(word domainName, List<word>& zoneNames, List<word>& interfaceNames, List<bool>& send, List<bool>& receive, List<bool>& smart_send)
{
    //
...
Foam::coupling1d::coupling1d(word domainName, List<word>& zoneNames, List<word>& interfaceNames, List<vector>& domainStarts, List<vector>& domainEnds,

...
//         scalar ChiB = 2.5 - omegaPQ;
        ...
        *(
        ...
        if(EcPQ > activationEnergy) // i.e. exchange reaction can possibly occur.
        {
            ...
            reactionProbabilities[1] = P_exch;
        }
...
//             Info << "mols[0] = " <<  mols[0] << endl;
//             Info << "mols[1] = " <<  mols[1] << endl;
//             Info << "nTotDissociationReactions = " << nTotDissociationReactions << endl;

...
{
    //- If parcel is of type to be deleted and sent through coupling interface
    ...
    else //- Otherwise just reflect as per specular wall
    {
        ...
        measurePropertiesAfterControl(p, 0);
    }
}

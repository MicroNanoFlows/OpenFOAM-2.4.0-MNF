...
#include "dsmcMixedDiffuseSpecularWallRotationFieldPatch.H"
...
defineTypeNameAndDebug(dsmcMixedDiffuseSpecularWallRotationFieldPatch, 0);

addToRunTimeSelectionTable(dsmcPatchBoundary, dsmcMixedDiffuseSpecularWallRotationFieldPatch, dictionary);
...
dsmcMixedDiffuseSpecularWallRotationFieldPatch::dsmcMixedDiffuseSpecularWallRotationFieldPatch
(
    Time& t,
    const polyMesh& mesh,
    dsmcCloud& cloud,
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
void dsmcMixedDiffuseSpecularWallRotationFieldPatch::initialConfiguration()
{}

void dsmcMixedDiffuseSpecularWallRotationFieldPatch::calculateProperties()
{}

void dsmcMixedDiffuseSpecularWallRotationFieldPatch::controlParticle(dsmcParcel& p, dsmcParcel::trackingData& td)
{
...
void dsmcMixedDiffuseSpecularWallRotationFieldPatch::output
(
...
void dsmcMixedDiffuseSpecularWallRotationFieldPatch::updateProperties(const dictionary& newDict)
{

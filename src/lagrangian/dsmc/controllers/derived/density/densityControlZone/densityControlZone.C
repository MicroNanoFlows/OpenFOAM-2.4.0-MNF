...
//     Info << "Thermal gradient test:" << nl << endl;
//     
//     scalar length = mag(endPoint_-startPoint_);
//     
//     label nBins = 10;
// 
//     Info << "\t (Description: picking 10 points and computing temperature)" << nl << endl;
//     
//     for(label n = 0; n < nBins+1; n++)
//     {
//         scalar y = length*n/nBins;
//         vector yVec = (y*normalVector_)+startPoint_;
//         
//         Info << "\t" << n << " Position (normalised): " << y << ", vector: " << yVec 
//             << ", temperature = " << getTemperature(yVec) << endl;
//     }
...
//                 scalar temperature = getTemperature(position);
...
// scalar densityControlZone::getTemperature(const vector& position)
// {
//     scalar temperature = temperature_;
// 
...
//     (
//         (y >= 0.0) &&
//         (y <= mag(endPoint_ - startPoint_))
//     )
//     {
//         temperature += (temperatureGradient_*y);
//     }
//     
//     return temperature;
// }

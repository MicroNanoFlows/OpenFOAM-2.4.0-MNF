...
void dsmcMassFluxSurface::calculateField()
{
    ...
    if(runTime.outputTime())
    {
        ...
        molFluxZone_[timeIndex_] = molsZone*cloud_.nParticle()/(averagingTime*zoneSurfaceArea_);
        massFluxZone_[timeIndex_] = massZone*cloud_.nParticle()/(averagingTime*zoneSurfaceArea_);
        massFlowZone_[timeIndex_] = massZone*cloud_.nParticle()/averagingTime;

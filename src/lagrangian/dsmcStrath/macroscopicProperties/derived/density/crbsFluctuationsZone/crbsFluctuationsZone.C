...
//             Info << "mass density = " << (mass_[c]/(cellVolumes_[c]*resetCounter_)) << endl;
            
//             Info << "cellCentres_[c]/domainLength_" << cellCentres_[c]/domainLength_ << endl;
            
//             rt_[n] = (mass_[c]/(volume/))*sin(twoPi*binCentres[c]/domainLength_);
        }
/*    }
...
//         const labelList& cells = mesh_.cellZones()[regionId_];
        ...
        forAll(binCentres, n)
        {
            ...
            Rt_ += rt_[n];
//             Info << "density: " << mass_[n]/volume << endl;
        }
...
// 
//         writeTimeData(timePath, fieldName_+"_"+regionName_+"Rt", timeField, RtField_);
    }
}

// const propertyField& crbsFluctuationsZone::fields() const
// {
//     return  fields_;
// }

...
#include "reflectiveRectangularBorderModified.H"
...
defineTypeNameAndDebug(reflectiveRectangularBorderModified, 0);

addToRunTimeSelectionTable(borderModel, reflectiveRectangularBorderModified, dictionary);
...
reflectiveRectangularBorderModified::reflectiveRectangularBorderModified
(
    Time& time,
    agentCloud& cloud,
...
void reflectiveRectangularBorderModified::initialConfiguration()
{
    // initialise borders
    initialiseBorders();
...
void reflectiveRectangularBorderModified::afterMove()
{
...
void reflectiveRectangularBorderModified::afterForce()
{
//     if(addWallForce_)
//     {
//         const List< DynamicList<agent*> >& cellOccupancy
...
void reflectiveRectangularBorderModified::checkClosedEndedBorders()
{
    forAll(borderList_, i)
    {
        ...
        if(rD > treshold_)
        {
            FatalErrorIn("reflectiveRectangularBorderModified::checkClosedEndedBorders()") 
...
void reflectiveRectangularBorderModified::initialiseBorders()
{
...
// METHOD 1 
void reflectiveRectangularBorderModified::reflect(label index, agent* p)
{
    ...
    if (edge == -1)
    {
            FatalErrorIn("reflectiveRectangularBorderModified::reflect()") 
...
void reflectiveRectangularBorderModified::write(const fileName& pathName)
{

...
#include "rectangularBorderWithForceField.H"
...
defineTypeNameAndDebug(rectangularBorderWithForceField, 0);

addToRunTimeSelectionTable(borderModel, rectangularBorderWithForceField, dictionary);
...
rectangularBorderWithForceField::rectangularBorderWithForceField
(
    Time& time,
    agentCloud& cloud,
...
void rectangularBorderWithForceField::initialConfiguration()
{
    // initialise borders
    initialiseBorders();
...
void rectangularBorderWithForceField::afterMove()
{
...
void rectangularBorderWithForceField::afterForce()
{
//     if(addWallForce_)
//     {
//         const List< DynamicList<agent*> >& cellOccupancy
...
void rectangularBorderWithForceField::checkClosedEndedBorders()
{
    forAll(borderList_, i)
    {
        ...
        if(rD > treshold_)
        {
            FatalErrorIn("rectangularBorderWithForceField::checkClosedEndedBorders()") 
...
void rectangularBorderWithForceField::initialiseBorders()
{
...
bool rectangularBorderWithForceField::isPointWithinBorder(label index, const vector& r)
{
    bool inside = true;
...
// METHOD 1 
void rectangularBorderWithForceField::reflect(label index, agent* p)
{
    ...
    if (edge == -1)
    {
            FatalErrorIn("rectangularBorderWithForceField::reflect()") 
...
void rectangularBorderWithForceField::write(const fileName& pathName)
{

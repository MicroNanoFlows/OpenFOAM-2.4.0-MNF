...
void borderModel::initialiseBorders()
{
...
bool borderModel::isPointWithinBorder(label index, const vector& r)
{
    bool inside = true;
...
void borderModel::reflect(label index, agent* p)
{

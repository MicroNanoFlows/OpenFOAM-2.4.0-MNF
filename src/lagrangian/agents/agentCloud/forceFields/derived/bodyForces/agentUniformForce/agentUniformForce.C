...
defineTypeNameAndDebug(agentUniformForce, 0);

addToRunTimeSelectionTable(bodyForce, agentUniformForce, dictionary);
...
agentUniformForce::agentUniformForce
(
    agentCloud& cloud,
    Time& t,
...
void agentUniformForce::initialConfiguration()
{}

void agentUniformForce::force(agent* p)
{
...
void agentUniformForce::newForce()
{
    
}


void agentUniformForce::setBoundBoxes()
{

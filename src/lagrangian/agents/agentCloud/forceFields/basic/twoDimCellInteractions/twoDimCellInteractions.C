...
Class
    Foam::twoDimCellInteractions<ParticleType>
...
Foam::twoDimCellInteractions<ParticleType>::twoDimCellInteractions
(
    const polyMesh& mesh,
...
template<class ParticleType>
void Foam::twoDimCellInteractions<ParticleType>::buildInteractionLists()
{
...
template<class ParticleType>
void Foam::twoDimCellInteractions<ParticleType>::buildOptimisedDIL()
{
...
template<class ParticleType>
void Foam::twoDimCellInteractions<ParticleType>::buildComplexDIL()
{
...
template<class ParticleType>
void Foam::twoDimCellInteractions<ParticleType>::buildFullInteractionList()
{
...
template<class ParticleType>
void Foam::twoDimCellInteractions<ParticleType>::buildInverseDirectInteractionList()
{
...
template<class ParticleType>
Foam::labelList Foam::twoDimCellInteractions<ParticleType>::returnNeighbouringCells(const label& cellI)
{
//     Info << "cellI: " << cellI 
//         << ", cell-centre: "
...
template<class ParticleType>
bool Foam::twoDimCellInteractions<ParticleType>::includeCell
(
...
template<class ParticleType>
bool Foam::twoDimCellInteractions<ParticleType>::interactingCells
(
    const label& cellI, 
    const label& cellN,
    const scalar& offset
...
template<class ParticleType>
Foam::boundedBox Foam::twoDimCellInteractions<ParticleType>::cellToBoundBox(const label& cellI)
{
...
template<class ParticleType>
Foam::pointField Foam::twoDimCellInteractions<ParticleType>::boundingCellPoints
(
    const label& cellI
)
{
...
//- NEW 
template<class ParticleType>
void Foam::twoDimCellInteractions<ParticleType>::buildReferredCells()
{
...
template<class ParticleType>
Foam::labelList Foam::twoDimCellInteractions<ParticleType>::getProcessorSourceCells
(
...
template<class ParticleType>
Foam::boundedBox Foam::twoDimCellInteractions<ParticleType>::faceToBoundBox
(
    const label& faceI,
//     const scalar& offset,
...
template<class ParticleType>
void Foam::twoDimCellInteractions<ParticleType>::setRIPL()
{
...
// NEW VERSION
template<class ParticleType>
void Foam::twoDimCellInteractions<ParticleType>::setReferredParticles
(
        ...
        if(recRefIds_[p].size() > 0)
        {
            if(p != Pstream::myProcNo())
            {
                ...
                {       
                    ...
                    // MB: re coded to solve for bug of empty cells
...
template<class ParticleType>
void Foam::twoDimCellInteractions<ParticleType>::checkForOverlaps()
{
    ...
    forAll(mols, i)
    {
        ...
        forAll(mols, j)
        {
            if(j>i)
            {
                ...
                if(mag(rI - rJ) < 0.01)
                {
                    FatalErrorIn("twoDimCellInteractions::checkForOverlaps Test") << nl
...
//serial assumption
template<class ParticleType>
void Foam::twoDimCellInteractions<ParticleType>::addParticle
(
...
template<class ParticleType>
void Foam::twoDimCellInteractions<ParticleType>::deleteParticle
(
    ParticleType* particle,
    DynamicList<ParticleType*>& newRefParticles,
    DynamicList<label>& refIds
...
template<class ParticleType>
void Foam::twoDimCellInteractions<ParticleType>::checkMesh(const scalar& rCut)
{
    Info << "twoDimCellInteractions: checkMesh for rCut = " << rCut << endl;
...
template<class ParticleType>
bool Foam::twoDimCellInteractions<ParticleType>::write()
{
    return write_;
}
...
template<class ParticleType>
void Foam::twoDimCellInteractions<ParticleType>::writeReferredCells()
{
...
/*
template<class ParticleType>
void Foam::twoDimCellInteractions<ParticleType>::writeReferredCloud()
{
    if(writeCloud_)
    {

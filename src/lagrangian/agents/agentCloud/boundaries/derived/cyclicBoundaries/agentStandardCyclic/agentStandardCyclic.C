...
defineTypeNameAndDebug(agentStandardCyclic, 0);

addToRunTimeSelectionTable(agentCyclicBoundary, agentStandardCyclic, dictionary);
...
agentStandardCyclic::agentStandardCyclic
(
    Time& t,
    const polyMesh& mesh,
    agentCloud& cloud,
...
void agentStandardCyclic::calculateProperties()
{}

void agentStandardCyclic::initialConfiguration()
{}



void agentStandardCyclic::control
(
    agent& p,
...
// void agentStandardCyclic::correctAfterParallelTransfer
// (
//     polyMolecule& mol,
//     const label& patchi,
...
void agentStandardCyclic::output
(

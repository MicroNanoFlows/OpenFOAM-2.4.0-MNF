...
#include "hogmanayControlRoseStreet.H"
...
defineTypeNameAndDebug(hogmanayControlRoseStreet, 0);

addToRunTimeSelectionTable(agentController, hogmanayControlRoseStreet, dictionary);


void hogmanayControlRoseStreet::setBoundBox
(
...
hogmanayControlRoseStreet::hogmanayControlRoseStreet
(
    Time& t,
    agentCloud& cloud,
...
void hogmanayControlRoseStreet::initialConfiguration()
{
...
void hogmanayControlRoseStreet::controlBeforeVelocityI()
{}

void hogmanayControlRoseStreet::controlBeforeMove()
{}

void hogmanayControlRoseStreet::controlBeforeForces()
{

}

void hogmanayControlRoseStreet::controlDuringForces
(
    agent* molI,
    agent* molJ
)
...
void hogmanayControlRoseStreet::panic
(
    agent* p,
...
void hogmanayControlRoseStreet::controlAfterForces()
{
    {
        IDLList<agent>::iterator p(cloud_.begin());
...
void hogmanayControlRoseStreet::initialiseBorders()
{
...
void hogmanayControlRoseStreet::controlAfterVelocityII()
{}

void hogmanayControlRoseStreet::calculateProperties()
{}

void hogmanayControlRoseStreet::output
(
...
scalar hogmanayControlRoseStreet::gaussianDistribution
(
    const scalar& mean,
    const scalar& range

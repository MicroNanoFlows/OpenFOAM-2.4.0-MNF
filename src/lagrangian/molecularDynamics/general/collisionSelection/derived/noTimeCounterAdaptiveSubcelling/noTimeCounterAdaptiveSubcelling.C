...
addToRunTimeSelectionTable(collisionSelection, noTimeCounterAdaptiveSubcelling, dictionary);
...
//             << "target sub-cell volume: " << subCellVolume
...
{
    // measure the number of parcels per unit volume.
//     rhoN_ = 0.42;

...
//                     const polyMolecule::constantProperties& constProp = molCloud_.constProps(molI->id());
    ...
    N_.boundaryField() = N_.boundaryField().boundaryInternalField();
    rhoN_.boundaryField() = rhoN_.boundaryField().boundaryInternalField();
    rhoM_.boundaryField() = rhoM_.boundaryField().boundaryInternalField();
    USAM_.boundaryField() = USAM_.boundaryField().boundaryInternalField();
    UCAM_.boundaryField() = UCAM_.boundaryField().boundaryInternalField();
    T_.boundaryField() = T_.boundaryField().boundaryInternalField();
    p_.boundaryField() = p_.boundaryField().boundaryInternalField();
    stress_.boundaryField() = stress_.boundaryField().boundaryInternalField();
